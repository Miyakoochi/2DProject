...
using CsLua;
using GameAbilitySystem.Buff.Apply.AOE;
...
namespace Editor.LuaConfig
{
    public static class LuaExampleConfig
    {
        ...
        public static List<Type> CSharpCallLuaList = new List<Type>()
        {
            ...
            typeof(AoeOnTick),
            typeof(AoeOnRemoved),
            typeof(AoeOnCharacterEnter),
            typeof(AoeOnCharacterLeave),
            typeof(AoeOnBulletEnter),
            typeof(AoeOnBulletLeave),
            
            typeof(BulletOnCreate),
            typeof(BulletOnHit),
            typeof(BulletOnRemoved),
            
            typeof(BuffOnOccur),
            typeof(BuffOnRemoved),
            typeof(BuffOnTick),
            typeof(BuffOnHit),
            typeof(BuffOnBeHurt),
            typeof(BuffOnKill),
            typeof(BuffOnBeKilled),
            typeof(BuffOnCast),
